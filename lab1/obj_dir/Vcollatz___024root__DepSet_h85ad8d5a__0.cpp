...
VL_INLINE_OPT void Vcollatz___024root___nba_sequent__TOP__0(Vcollatz___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vdly__collatz__DOT__current;
    __Vdly__collatz__DOT__current = 0;
    CData/*0:0*/ __Vdly__collatz__DOT__computation_done;
    __Vdly__collatz__DOT__computation_done = 0;
    // Body
    __Vdly__collatz__DOT__computation_done = vlSelf->collatz__DOT__computation_done;
    __Vdly__collatz__DOT__current = vlSelf->collatz__DOT__current;
    if (vlSelf->go) {
        __Vdly__collatz__DOT__current = vlSelf->n;
        __Vdly__collatz__DOT__computation_done = 0U;
    } else if (((1U != vlSelf->collatz__DOT__current) 
                & (~ (IData)(vlSelf->collatz__DOT__computation_done)))) {
        __Vdly__collatz__DOT__current = ((1U & vlSelf->collatz__DOT__current)
                                          ? ((IData)(1U) 
                                             + ((IData)(3U) 
                                                * vlSelf->collatz__DOT__current))
                                          : (vlSelf->collatz__DOT__current 
                                             >> 1U));
    }
    if ((1U == vlSelf->collatz__DOT__current)) {
        __Vdly__collatz__DOT__computation_done = 1U;
    }
    vlSelf->collatz__DOT__current = __Vdly__collatz__DOT__current;
    vlSelf->collatz__DOT__computation_done = __Vdly__collatz__DOT__computation_done;
    vlSelf->dout = vlSelf->collatz__DOT__current;
    vlSelf->done = vlSelf->collatz__DOT__computation_done;
}
