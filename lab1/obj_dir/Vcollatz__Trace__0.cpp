...
void Vcollatz___024root__trace_chg_sub_0(Vcollatz___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vcollatz___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcollatz___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vcollatz___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vcollatz___024root__trace_chg_sub_0(Vcollatz___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vcollatz__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcollatz___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+5,(vlSelf->collatz__DOT__current),32);
    bufp->chgBit(oldp+6,(vlSelf->collatz__DOT__computation_done));
}
